// Configurações do Firebase para ambiente de DESENVOLVIMENTO
// Este arquivo é usado quando rodamos 'ng serve' (localhost)
export const environment = {
  production: false,  // Indica ambiente de desenvolvimento
